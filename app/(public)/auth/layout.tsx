...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[65%] relative overflow-hidden flex-col">
        {/* Background Image */}
        <div
          className="absolute inset-0 bg-cover bg-left"
          style={{
            backgroundImage: 'url("/Login/Bg-Login-Ravelle.jpg")',
          }}
        />
        {/* Overlay */}
      ...
      {/* RIGHT — Form Panel */}
      <div className="w-full lg:w-[35%] bg-[#f9f8f6] flex flex-col justify-center px-8 sm:px-12 md:px-16 py-12 relative">
