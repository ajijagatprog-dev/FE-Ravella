        ...
        if (allRes.data.status === "success") {
          const mapped = allRes.data.data.data.map((allItem: any) => ({
            ...
            excerpt:
              allItem.excerpt ||
              (allItem.content
                ? allItem.content.substring(0, 100) + "..."
                : ""),
            image:
              allItem.image ||
              "https://images.unsplash.com/photo-1504711434969-e33886168f5c?w=800&q=80",
            category: allItem.category,
            date: allItem.published_at
              ? new Date(allItem.published_at).toLocaleDateString("id-ID", {
                  day: "numeric",
                  month: "long",
                  year: "numeric",
                })
          ...
          const catRelated = mapped
            .filter(
              (a: any) => a.category === item.category && a.id !== item.id,
            )
            .slice(0, 3);
          const suggestions =
            catRelated.length >= 3
              ...
              : [
                  ...
                  ...mapped
                    .filter(
                      (a: any) =>
                        a.id !== item.id &&
                        !catRelated.some((r: any) => r.id === a.id),
                    )
                    .slice(0, 3 - catRelated.length),
                ];
  ...
  useEffect(() => {
    ...
    api
      ...
      .then((res) => {
        if (res.data.status === "success") {
          setArticle((prev) =>
            prev ? { ...prev, views: res.data.views.toString() } : prev,
          );
        }
      })
      .catch(() => {});
      ...
      <section className="relative h-[450px] sm:h-[550px] md:h-[650px] overflow-hidden bg-neutral-900">
        ...
        <div className="relative z-10 h-full flex flex-col justify-end px-6 md:px-16 lg:px-24 xl:px-40 pb-16 sm:pb-24">
          <motion.div
            ...
            className="max-w-4xl"
          >
            <span className="inline-block px-4 py-1.5 bg-white/10 backdrop-blur-md text-white text-[10px] tracking-[0.3em] font-black uppercase mb-4 border border-white/20">
              {article.category}
            </span>
          ...
          <article className="max-w-4xl">
            ...
            <div className="flex items-center justify-between mb-16 pb-8 border-b border-neutral-100">
              ...
              <div className="flex items-center gap-6">
                ...
                <button className="text-neutral-400 hover:text-neutral-900 transition-colors ml-2">
                      ...
                      {lines
                        ...
                        .map((line, li) => {
                          ...
                          return (
                            <li
                              key={li}
                              className="flex items-start gap-4 text-neutral-600 text-lg font-light leading-relaxed"
                            >
            ...
            <div className="mt-24 pt-12 border-t border-neutral-100 flex flex-wrap items-center justify-between gap-8">
              ...
              <div className="flex items-center gap-3">
                <button className="p-3 border border-neutral-100 hover:bg-neutral-900 hover:text-white transition-all">
            ...
            <div className="sticky top-32 space-y-12">
              ...
              <div className="p-10 border border-neutral-100 bg-neutral-50">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-400 mb-2">
                    Written By
                  </p>
                  <h4
                  ...
                  <p className="text-xs text-neutral-500 font-light leading-relaxed">
                    Expert contributor focusing on kitchen innovation and
                    lifestyle trends.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-400 border-b border-neutral-100 pb-4">
                  Article Details
                </p>
                {[
        ...
        <section className="bg-neutral-50 py-24 sm:py-32 border-t border-neutral-100">
          <div className="max-w-[1600px] mx-auto px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40">
            <div className="flex items-center justify-between mb-16">
              ...
              <Link
                href="/news"
                className="text-[10px] font-black uppercase tracking-[0.3em] text-neutral-400 hover:text-neutral-900 transition-colors"
              >
                View All Stories
              </Link>
            </div>
