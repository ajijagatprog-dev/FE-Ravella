        ...
        <div className="mb-20">
          <div className="flex justify-center mb-12">
            <motion.div
              ...
              viewport={{ once: true }}
              className="flex items-center gap-3 w-full max-w-xl px-5 py-2.5 sm:py-3.5 rounded-full border border-neutral-200 bg-white shadow-sm hover:shadow-md focus-within:shadow-md focus-within:border-neutral-400 transition-all duration-300"
            >
