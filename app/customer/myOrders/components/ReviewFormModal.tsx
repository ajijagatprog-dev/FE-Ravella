...
import { X, Star, Loader2, CheckCircle2, Image as ImageIcon } from "lucide-react";
...
export default function ReviewFormModal({ isOpen, onClose, onSuccess, product, orderId }: Props) {
        ...
        >
          ...
          {submitted ? (
            <div className="p-10 flex flex-col items-center text-center space-y-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-stone-900">Ulasan Terkirim!</h3>
                <p className="text-sm text-stone-500 mt-2">Terima kasih atas ulasan Anda. Ulasan akan tampil setelah diverifikasi oleh admin.</p>
              </div>
            </div>
          ) : (
            <>
              ...
              <div className="px-6 py-4 border-b border-stone-100 flex items-center justify-between">
                <h2 className="text-lg font-bold text-stone-800">Beri Ulasan</h2>
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div className="flex items-center gap-4 p-4 bg-stone-50 rounded-2xl">
                    ...
                    <p className="text-sm font-bold text-stone-700 line-clamp-2">{product.name}</p>
                </div>

                {/* Rating Input */}
                <div className="text-center space-y-3">
                  <p className="text-xs font-bold text-stone-400 uppercase tracking-widest">Kualitas Produk</p>
                ...
                <div className="space-y-2">
                  <label className="text-xs font-bold text-stone-400 uppercase tracking-widest">Bagikan Pengalaman Anda</label>
                  <textarea
                    rows={4}
                    value={comment}
