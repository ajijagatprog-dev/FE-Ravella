    ...
    const fetchTracking = async () => {
      ...
      try {
        const res = await api.get(
          `/customer/orders/${order.orderNumber}/tracking`,
        );
    ...
    <>
              ...
              <div className="flex items-center gap-3 bg-rose-50 border border-rose-200 rounded-xl px-4 py-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-rose-500">
                    This order was cancelled on {order.deliveryDate}.
                  </p>
                </div>
              </div>
            )}
              ...
              <div className="bg-stone-50 rounded-xl p-4">
                ...
                {order.trackingNumber && (
                  <div className="mt-4 pt-4 border-t border-stone-200">
                    ...
                    <p className="text-sm font-semibold text-stone-700 uppercase">
              ...
              <div className="bg-blue-50/50 border border-blue-100 rounded-xl p-5 mt-4 animate-in fade-in slide-in-from-top-2">
                ...
                {loadingTracking ? (
                  ...
                  <p className="text-sm text-stone-500">
                    Gagal memuat detail pengiriman atau data belum tersedia.
                  </p>
                )}
              </div>
            )}
      ...
      {reviewProduct && (
        <ReviewFormModal
          ...
          orderId={order.id}
          existingReview={reviewProduct.review}
        />
      )}
    </>
  );
