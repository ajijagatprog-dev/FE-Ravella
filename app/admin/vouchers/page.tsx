  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (form.max_discount)
        payload.max_discount = parseFloat(form.max_discount);
                    ...
                    <td className="px-5 py-4 font-medium text-stone-800">
                      ...
                      {v.max_discount && v.type === "percent" && (
                        <span className="text-[10px] text-stone-400 block">
                          maks. {formatPrice(v.max_discount)}
                        </span>
                      )}
                    </td>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  <label className="block text-[11px] uppercase tracking-wider text-stone-500 font-bold mb-1">
                    Kode Produk / SKU (Opsional)
                  </label>
                  <input
                    value={form.sku}
                    onChange={(e) => setForm({ ...form, sku: e.target.value })}
                    placeholder="Contoh: SKU-123"
                    className="w-full border border-stone-200 px-3 py-2 text-sm bg-stone-50 text-stone-900 focus:outline-none focus:border-stone-900"
                  />
                </div>
                <div>
                  <label className="block text-[11px] uppercase tracking-wider text-stone-500 font-bold mb-1">
                  ...
                  <input
                    ...
                    placeholder="WELCOMERAVELLA"
                    className="w-full border border-stone-200 px-3 py-2 text-sm font-mono uppercase bg-stone-50 text-stone-900 focus:outline-none focus:border-stone-900"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full border border-stone-200 px-3 py-2 text-sm bg-white text-stone-900 focus:outline-none focus:border-stone-900 font-semibold"
                  />
                </div>
                ...
                <div className="col-span-2">
                  ...
                  <textarea
                    ...
                    rows={2}
                    placeholder="Catatan tambahan untuk voucher ini..."
                    className="w-full border border-stone-200 px-3 py-2 text-sm bg-white text-stone-900 focus:outline-none focus:border-stone-900 resize-none"
                  />
                </div>
