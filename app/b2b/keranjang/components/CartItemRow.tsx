            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between flex-wrap gap-3">
                    <div className="flex items-center gap-3">
                        {/* Unit Price */}
                        <div>
                            <p className="text-[10px] text-stone-400 uppercase tracking-wider mb-0.5">Unit Price</p>
                            <p className="text-sm font-bold text-stone-800">{formatIDR(product.price)}</p>
                        </div>
                        ...
                        <div className="flex items-center gap-1 bg-stone-100 rounded-xl p-1">
                            ...
                            <input
                                ...
                                onChange={(e) => {
                                    ...
                                    if (!isNaN(v)) onUpdateQty(product.id, v);
                                }}
                    ...
                    <div className="flex items-center gap-3">
                        <div className="text-right">
                            <p className="text-[10px] text-stone-400 uppercase tracking-wider mb-0.5">Subtotal</p>
                            <p className="text-base font-black text-blue-600">{formatIDR(subtotal)}</p>
                        </div>
                        <button
